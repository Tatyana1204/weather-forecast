...
const QualityBox2 = (props: QualityBoxProps) => {
  ...
  switch (props.value) {
    case 1:
      airQualityValue =
        "Хорошее. Можно проводить время на улице без ограничений.";
      break;
    case 2:
      airQualityValue =
        "Среднее. В целом является приемлемым для большинства людей. ";
      break;
    case 3:
      airQualityValue =
        "Cлегка вредное. Загрязнение воздуха достигло высокого уровня";
      break;
    case 4:
    ...
    case 6:
      airQualityValue =
        "Опасное. Любое пребывание на улице может привести к серьезным осложнениям";
      break;
    default:
      airQualityValue = "";
      break;
